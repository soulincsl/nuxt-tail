    ...
    <div>
        <div class="container m-auto px-2">
            <!-- <div
                ...
                "
            >
                <div class="bg-red-500 text-center">ONE</div>
                <div class="bg-green-400 text-center">TWO</div>
                <div class="bg-yellow-500 text-center">THREE</div>
                <div class="bg-blue-500 text-center">Four</div>
            </div> -->
